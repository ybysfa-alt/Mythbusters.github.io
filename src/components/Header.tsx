      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium">Categories</a>
            <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium">Featured</a>
            <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium">About</a>
            <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium">Contact</a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-800 py-4 space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium py-2">Categories</a>
              <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium py-2">Featured</a>
              <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium py-2">About</a>
              <a href="#" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium py-2">Contact</a>
            </nav>
          </div>
        )}
      </div>
